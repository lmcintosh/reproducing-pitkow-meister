...
- 2000 simulations to get probability distribution
- product of a sinusoid and a Gaussian to get filter
- used sigmoid from reduced model
- all the usual LNP stages
